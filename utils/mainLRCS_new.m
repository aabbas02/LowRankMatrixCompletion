...
for mc = 1 : MC
    ...
    [SDVals_sLclCllps(mc,:), time_sLclCllps(mc,:)] = altGDMin_and_altMin(Ak_, ykPerm_,AkCllps_, ykCllps_, U0Cllps,r, ...
        T,Ustr,r_,updtP,same,altMin, T_LS, exact, eta_c, eta_L, cllpsOnly, distributed);
    ...
    [SDVals_AltMinCllps(mc,:), time_AltMinCllps(mc,:)] = altGDMin_and_altMin(Ak_, ykPerm_, AkCllps_, ykCllps_, U0Cllps, ...
        r,TAltMin,Ustr,r_,updtP,same,altMin,T_LS,exact,eta_c,eta_L,cllpsOnly, distributed);
    % ---------------------
    % --- UNCOLLAPSED -----
    % ---------------------
...
%---
plotRslts_New(time_sLcl, SDVals_sLcl, ...
    ...
    n,q,r,m,numBlocks,MC,same,T_LS,eta_c,eta_L, distributed);
