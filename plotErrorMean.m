function plotErrorMean(error_mean_MC, n, q, r, p, L, L_byz, MC, C1,attck,real,C_elem,C_gm,C_krum)
    % Create a figure
    figure;
    % Plot the errors
    ...
    stringTitle = ['Real_MC_', num2str(MC), ...
                   ...
                   '_C_elem_',num2str(C_elem), '_C_gm_',num2str(C_gm), '_C_krum', num2str(C_krum)...
                   '_ID', num2str(ID)];
    % Save the figure
    savefig([stringTitle, '.fig']);
    save("Realvars"+ stringTitle + ".mat","error_mean_MC","n","q","r","p","L","L_byz","MC","C1","attck")
end