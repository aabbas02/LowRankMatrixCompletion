function saveFigCntrl(numData,dir)
    cd (dir)
    clc
    close all
    load("1.mat");
    ...
    MC = strt;
    strt = 1;
    load([num2str(i) +'_ProjGD.mat'],'SDProjGD','timeProjGD','mc','T');
    ...
    for i = 1:5
        ...
        MCPrjGD = strt; %= legnth of SD/Time arrays
        % -- 
        ...
        % --
        SDProjGD = SDProjGD_(1:MCPrjGD,:);
        timeProjGD = timeProjGD_(1:MCPrjGD,:);
        %---------------------------------------------
        % 1
        ...
        %9
        SDProjGD = sum(SDProjGD,1)/MCPrjGD;
        timeProjGD = sum(timeProjGD,1)/MCPrjGD;
        %----------------------------------------------------------------------
        %------------ Downsample 
        % 2
        ...
        % 7
        % 8
        SDAltGDMinCntrl = downsample(SDAltGDMinCntrl,4);
        timeAltGDMinCntrl = downsample(timeAltGDMinCntrl,4);   
        %9 
        ...
        semilogy(timeProjGD(timeProjGD <= timeSD ),...
                 ...
                 'ProjGD(Cntrl.)', ...
                 'LineWidth',1.35,'Marker','o','MarkerSize',9,'Color',"#7E2F8E")
        grid on
        ...
        stringTitle = ['Cntrl_Wrkrs_',num2str(numWrkrs),'Max',num2str(cores),'_MC_',num2str(MC),...
