...
for mc=1:MC
    ...
    for t=1:T 
        ...
        if mod (t,1) == 0
            fprintf('Element Wise Median. n = %d, q = %d, r = %d L  = %d, Lbyz = %d, Iteration %d, SD Error: %f\n',n,q,r,L,L_byz,t, error(2,t,mc));
        end
    end
    ...
    for t=1:T 
        ...
        if mod (t,1) == 0
             fprintf('GM. n = %d, q = %d, r = %d, L = %d, L_byz = %d, Iteration %d, SD Error: %f\n',n,q,r,L,L_byz,t, error(3,t,mc));
        end
...
hold off
ID = randi(1e3);
stringTitle = ['GM', num2str(MC), ...
               '_n_', num2str(n), '_q_', num2str(q), '_r_', ...
               num2str(r), '_L_', num2str(L), '_Lbyz_',num2str(Lbyz),'_C1_',num2str(C1),'_ID',num2str(ID)];
