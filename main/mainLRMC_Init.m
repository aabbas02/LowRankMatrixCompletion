...
for i = 1 : length(numBlocksTry_)
    ...
    for mc = 1 : MC
        ...
        [SDVals,Errs] = altMinCntrlNew(n,q, r, U0, Ustr, T, rowIdx, Xcol, colIdx, Xrow, X0,idx,Xzeros);
        ...
        [XzerosCllps, rowIdxCllps, colIdxCllps, XcolCllps, XrowCllps,idx] = processMatrix(XzerosCllps, n, q, p,real);
        ...
        [XzerosPerm, rowIdxPerm, colIdxPerm, XcolPerm, XrowPerm,idx] = processMatrix(XzerosPerm, n, q, p,real);
        [SDVals,Errs] = altMinCntrlNew(n,q, r, U0Perm, Ustr, T, ...
...
X0CllpsErr_'
X0PermErr_'
%plotRslts(SDU0, SDU0Cllps, SDU0Cllps_, SDU0Perm,n,q,r,p,numBlocksTry_,MC,same,fill,real);
n,q
toc
...
function plotRslts(SDU0, SDU0Cllps, SDU0Cllps_, SDU0Perm,n,q,r,p,numBlocks_,MC,same,fill,real)
    figure;
    hold on
    if real == 0
    ...
    plot(numBlocks_,SDU0Cllps_, ...
        'DisplayName', 'SDVals Cllps_', 'LineWidth', 1.45, 'Marker', 'o', 'MarkerSize', 7);
