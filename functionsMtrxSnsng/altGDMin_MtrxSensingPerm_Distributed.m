function [SDVals,times] = altGDMin_MtrxSensingPerm_Distributed(Ak_, ykPerm_,AkCllps_,ykCllps_, ...
    Uinit,r,T,Ustr,r_,updtP,same, ...
    altMin,T_LS,exact,eta_c,eta_L,cllpsOnly)
	% This function should implement tow algorithms: i) altGDMin and ii) altMin with both permuted and non-permuted measurements
